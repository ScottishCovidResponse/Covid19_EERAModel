...
public:
   ...
   * @param log Logger
   */
  OriginalModel(const CommonModelInputParameters &commonParameters,
...
private:
  ...
  /**
   * @brief Generate an infection spread as per the structure of the original
   * EERA model
   *
  ...
  InfectionState GenerateInfectionSpread(Compartments &pop,
                                         ...
                                         ::EERAModel::params fixed_parameters,
