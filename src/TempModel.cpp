...
TempModel::TempModel(const CommonModelInputParameters &commonParameters,
                     const ObservationsForModels &observations,
...
std::vector<double>
TempModel::BuildPopulationSeed(const std::vector<int> &age_nums) {
...
TempModel::BuildPopulationArray(const std::vector<int> &age_nums,
                                const seed &seedlist) {
...
void TempModel::GenerateDiseasedPopulation(std::vector<Compartments> &poparray,
                                           std::vector<double> &seedarray,
...
Status TempModel::Run(std::vector<double> parameter_set, const seed &seedlist,
                      int day_shut, int n_sim_steps) {
  Status status = {{0}, {0}, {0}, {}, {}};
...
InfectionState
TempModel::GenerateInfectionSpread(Compartments &pop, const int &n_hospitalised,
...
std::vector<double> TempModel::GenerateForcesOfInfection(
