...
//				outs_vec.sum_sq = 1.e06;
				...
				ModelSelect(outs_vec, fixed_parameters, per_age_data,
							...
							modelInputParameters_.day_shut, rng_, obs_selections.hospitalised, obs_selections.deaths, 
							modelInputParameters_.model_structure);
...
void InferenceFramework::ModelSelect(EERAModel::particle& outvec, const std::vector<params>& fixed_parameters,
	...
	seed seedlist, int day_shut, Random::RNGInterface::Sptr rng, const std::vector<int>& obsHosp, 
