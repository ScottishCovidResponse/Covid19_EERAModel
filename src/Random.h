...
public:
   ...
   */
  virtual void Multinomial(size_t K, unsigned int N, const double p[],
                           unsigned int n[]) = 0;
...
public:
   ...
   * @brief Contructor
   *
   * Sets up a handle for the underlying GSL and STL random number generator.
   * Seeds the randomiser with the supplied seed
   *
